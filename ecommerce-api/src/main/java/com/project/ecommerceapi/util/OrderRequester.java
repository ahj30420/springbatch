package com.project.ecommerceapi.util;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.project.ecommerceapi.controller.order.OrderItemRequest;
import com.project.ecommerceapi.controller.order.OrderRequest;
import com.project.ecommerceapi.controller.order.OrderResponse;
import com.project.ecommerceapi.controller.order.PaymentRequest;
...
public class OrderRequester {
    ...
    private static String fetchProducts(int page, int size)
            throws IOException, InterruptedException {
        String url = String.format("%s?page=%d&size=%d&sort=productId,asc", PRODUCTS_URL, page,
                size);
    ...
    private static OrderResponse createOrder(String productId, int quantity) {
        ...
        try {
            ...
            if (response.statusCode() == 200) {
                OrderResponse orderResponse = OBJECT_MAPPER.readValue(response.body(),
                        OrderResponse.class);
