package com.project.ecommerceapi.service.transaction;

import com.project.ecommerceapi.domain.transaction.TransactionStatus;
import com.project.ecommerceapi.domain.transaction.TransactionType;
import com.project.ecommerceapi.service.order.OrderResult;
...
public class TransactionLoggingAspect {
    ...
    @Pointcut("execution(* com.project.ecommerceapi.service.order.OrderService.order(..))")
    ...
    @Pointcut("execution(* com.project.ecommerceapi.service.order.OrderService.completePayment(..))")
    ...
    @Pointcut("execution(* com.project.ecommerceapi.service.order.OrderService.completeOrder(..))")
    ...
    @Pointcut("execution(* com.project.ecommerceapi.service.order.OrderService.cancelOrder(..))")
    ...
    public void logOrderCancellationSuccess(Object cancelledOrder) {
        transactionService.logTransaction(
                TransactionType.ODER_CANCELLATION,
                TransactionStatus.SUCCESS,
                "주문이 성공적으로 취소되었습니다.",
