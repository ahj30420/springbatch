...
import com.project.batch.dto.transaction.TransactionLogMdc;
...
class TransactionReportTest {
    ...
    void testAddTransactionReport() {
        TransactionReport report1 = createSampleTransactionReport("2024-09-21", "PURCHASE", 1L,
                1000L,
                "CUST-1", "ORDER-1", "CREDIT_CARD", 2L, 3L);
        TransactionReport report2 = createSampleTransactionReport("2024-09-21", "PURCHASE", 1L,
                2000L,
